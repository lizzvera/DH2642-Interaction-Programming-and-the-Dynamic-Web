    ...
    this.update = function () {
        ...
        for (var i = 0; i < this.dishes.length; i++) {
            sout += "<div class='row displayRecipe'> <div class='col-lg-2'><img src='images/" + this.dishes[i].image + "'/>"
                + "</div><div class='col-lg-4'> <h4 class='allfilterDishesTitle'>" + this.dishes[i].name + "</h4>" +
                "<font>" + this.dishes[i].description + "</font></div><div class='col-lg-4'> <h4 class='allfilterDishesTitle'>Preparation</h4>" +
